...
var mix_values = [10, 11, 12, 13, 14, 17, 15, 19, 20];
...
var grades = [76, 72, 95, 39, 87, 45, 37, 35, 23, 96, 14];
...
var values = [20, 30, 40, 45, 60, 100, 300, 10, 900];
var get_values = values[0];
function largest_values(values) {
